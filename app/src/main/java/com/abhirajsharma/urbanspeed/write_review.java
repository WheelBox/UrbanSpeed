        ...
        if(layout_code==1){
            ...
            post.setOnClickListener( new View.OnClickListener( ) {
                ...
                public void onClick(View view) {
                    ...
                    if(text.isEmpty()){
                        Toast.makeText( write_review.this, "Write your review", Toast.LENGTH_SHORT ).show( );
                    }
                    else {
                        ...
                        FirebaseFirestore.getInstance().collection( "ORDERS" ).document(OID).collection( "ORDER_LIST" ).document(PID)
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    ...
                                    Toast.makeText( write_review.this, "Thank You for your review", Toast.LENGTH_SHORT ).show( );
                                    FirebaseFirestore.getInstance().collection( "STORES" ).document( store_id ).collection( "PRODUCTS" ).document(PID).collection( "REVIEWS" ).document(OID)
                                            .update( Review ).addOnCompleteListener( new OnCompleteListener<Void>( ) {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
                                            Intent intent=new Intent( write_review.this,myOrder.class );
                ...
                public void onClick(View view) {
                    ...
                    if(text.isEmpty()){
                        ...
                        FirebaseFirestore.getInstance().collection( "USERS" ).document( FirebaseAuth.getInstance( ).getCurrentUser( ).getUid( ) )
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    Toast.makeText( write_review.this, "Review Uploaded", Toast.LENGTH_SHORT ).show( );
